...
from PyQt6.QtWidgets import (
    ...
    QDialogButtonBox, QTabBar, QFileDialog, QToolButton, QTreeView,
    QInputDialog, QPushButton, QGraphicsOpacityEffect, QApplication,
)
from PyQt6.QtCore import (
    Qt, QUrl, QTimer, QEvent, QDir, QPropertyAnimation,
    QEasingCurve, QParallelAnimationGroup, QRect, QSize,
)
from PyQt6.QtWebEngineWidgets import QWebEngineView
from PyQt6.QtGui import (
    QAction, QShortcut, QFileSystemModel, QPen, QIcon, QDesktopServices,
    QKeySequence, QColor, QFont,
)
